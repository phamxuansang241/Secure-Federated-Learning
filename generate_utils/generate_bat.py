    ...
    for y in dir_list_y:
        for z in dir_list_z:
            ...
            for t in dir_list_t:
                ...
                batch_file = f'{batch_file_base}/{x}/{y}/{z_str}/{t}/50_global_epochs/batch.bat'
                ...
                with open(batch_file, 'w') as f:
                    f.write('@echo off\n\n')
                    f.write('    echo +++++++++\n')
                    f.write(f'for /f "delims=" %%a in (\'dir /s /b .\\generate_utils\\generated_files\\json_files\\{x}\\{y}\\{z_str}\\{t}\\50_global_epochs\\*.json\') do (\n')
                    f.write('    python main.py -cf "%%a"\n')
                    f.write('    echo python main.py -cf "%%a"\n')
                    f.write('    echo +++++++++\n')
                    f.write(')\n\n')
